...
static void mode3RenderLine (u32 *lineMix)
#else
static void mode3RenderLine (u16 *lineMix)
#endif
{
...
#ifdef GBA_USE_RGBA8888
static void mode3RenderLineNoWindow (u32 *lineMix)
#else
static void mode3RenderLineNoWindow (u16 *lineMix)
#endif
{
#ifdef REPORT_VIDEO_MODES
...
#ifdef GBA_USE_RGBA8888
static void mode3RenderLineAll (u32 *lineMix)
#else
static void mode3RenderLineAll (u16 *lineMix)
#endif
{
#ifdef REPORT_VIDEO_MODES
