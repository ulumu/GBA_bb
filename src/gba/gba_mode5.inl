...
static void mode5RenderLine (u32 *lineMix)
#else
static void mode5RenderLine (u16 *lineMix)
#endif
{
...
#ifdef GBA_USE_RGBA8888
static void mode5RenderLineNoWindow (u32 *lineMix)
#else
static void mode5RenderLineNoWindow (u16 *lineMix)
#endif
{
#ifdef REPORT_VIDEO_MODES
...
#ifdef GBA_USE_RGBA8888
static void mode5RenderLineAll (u32 *lineMix)
#else
static void mode5RenderLineAll (u16 *lineMix)
#endif
{
#ifdef REPORT_VIDEO_MODES
